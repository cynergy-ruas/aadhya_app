...
import 'package:dwimay/pages/timeline/event_timeline.dart';
    ...
    return Scaffold(
      body: Center(
        ...
        child: EventLoader(
          ...
          // for now the timeline is being displayed
          // TODO: Make Depatment wise cards which then go to the timeline page
          ...
          // its begins load as soon as events page is opened
          // this skips the [onUninitialized] task
          beginLoad: true,
        ),
      ),
    );
